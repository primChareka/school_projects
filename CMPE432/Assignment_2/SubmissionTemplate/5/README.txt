...
4. Download python code from git hub
	# wget https://raw.githubusercontent.com/primChareka/CMPE432Assignment2/master/SubmissionTemplate/5/sparkSQL.py

5. Execute python script
	spark-submit ./sparkRDD.py 

6. Results will stored in a file called outputDataRDD in the same directory in which the script was executed.